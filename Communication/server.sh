#/bin/sh
###############################################################################
# Nom du fichier : server.sh
# Date : 08/05/2019
# Auteur : Sylvain Nion
# Description : Scrit permettant d'initialiser un espace de chat sur le PC du 
#               mediateur et permettre au centre de controle de discuter
# Requis : printf
###############################################################################

host_name=host
#client_name=client
client_name=$(echo "Centre de controle")
